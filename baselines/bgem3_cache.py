...
from benchmarks.utils.data_utils import bgem3_cache_root, load_longdocurl_samples, load_mmlongbench_samples
...
def prepare_bgem3_cache(cfg):
    ...
    if benchmark_name == "mmlongbench":
        ...
        for doc_id, sample in sample_by_doc.items():
            ...
            doc_output_path = _variant_root(bgem3_cache_root(benchmark_name, "doc_embeddings"), doc_variant) / f"{doc_key}.safetensors"
            metadata_output_path = _variant_root(bgem3_cache_root(benchmark_name, "chunk_metadata"), doc_variant) / f"{doc_key}.json"
        ...
        for sample in samples:
            ...
            query_output_path = _variant_root(bgem3_cache_root(benchmark_name, "query_embeddings"), query_variant) / f"{query_key}.safetensors"
