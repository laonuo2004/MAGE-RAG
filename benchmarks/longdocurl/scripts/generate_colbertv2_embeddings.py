...
DEFAULTS = {
    "description": "Generate ColBERTv2 chunk/query embeddings for LongDocURL.",
    "input_path": CODE_DIR / "benchmarks" / "longdocurl" / "data" / "raw" / "LongDocURL.jsonl",
    "doc_output_dir": CODE_DIR / "benchmarks" / "longdocurl" / "tmp" / "colbertv2" / "doc_embeddings",
    "query_output_dir": CODE_DIR / "benchmarks" / "longdocurl" / "tmp" / "colbertv2" / "query_embeddings",
    "metadata_output_dir": CODE_DIR / "benchmarks" / "longdocurl" / "tmp" / "colbertv2" / "chunk_metadata",
...
if __name__ == "__main__":
    run_embedding_cache_cli(baseline_name="colbertv2", benchmark_name="longdocurl", defaults=DEFAULTS)
